...
import tw.taicca.tccf.databinding.FragmentScheduleTabBinding
import tw.taicca.tccf.extension.*
import tw.taicca.tccf.model.ConfSchedule
import tw.taicca.tccf.ui.MainActivity
            ...
            try {
                ...
                client.newCall(request).asyncExecute().run {
                    if (isSuccessful) {
                        ...
                        val cached = PreferenceUtil.loadRawSchedule2(mActivity).trim()
                        ...
                        if (cached != new) {
                            PreferenceUtil.saveSchedule2(mActivity, new)
                            vm.reloadSchedule()
                        }
                    } else {
